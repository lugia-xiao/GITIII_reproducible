...
from dataloader import BC_dataset
...
if __name__=="__main__":
    ...
    batch_size = 90  # approximately one-sample: 2G CUDA memory, 20 batch size is for A100 40G
    lr = 1e-4
    data_dir = "../../data/BC/processed1/"
    folds = 5
    epochs = 50

    dataset = BC_dataset(processed_dir=data_dir)
    ...
    my_model = GITIII(genes, ligands_info, node_dim=256, edge_dim=48, num_heads=2,
                      n_layers=1, node_dim_small=16,att_dim=8)
