...
class Embedding(nn.Module):
    def __init__(self,genes,ligands_info,node_dim,edge_dim):
        super().__init__()
    ...
    def forward(self,x):
        ...
        ligand_score=distance_scaler*data_ligand.unsqueeze(dim=1)#B,N,C->B,1,N,C
        ...
        return [node_features,edges,embedding]
