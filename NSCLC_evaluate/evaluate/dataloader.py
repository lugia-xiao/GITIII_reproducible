...
class NSCLC_dataset(Dataset):
    def __init__(self, processed_dir, num_neighbors=50, col_centerx="CenterX_global_px",
                 col_centery="CenterY_global_px", col_cell_type="CellType"):
        if processed_dir[-1] != "/":
...
class NSCLC_evaluate_dataset(Dataset):
    def __init__(self, processed_dir, sample, num_neighbors=50, col_centerx="CenterX_global_px",
                 col_centery="CenterY_global_px", col_cell_type="CellType"):
        if processed_dir[-1] != "/":
            processed_dir = processed_dir + "/"
